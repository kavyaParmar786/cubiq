    ...
    <div className="min-h-screen bg-mc-dark-bg flex items-center justify-center px-4 py-12 relative">
      ...
      <div className="relative z-10 w-full max-w-md">
            ...
            <label className="flex items-start gap-3 cursor-pointer mt-2">
              <button
                ...
                className={`w-5 h-5 border-2 flex items-center justify-center flex-shrink-0 mt-0.5 transition-all ${
                  agreed ? 'bg-mc-grass border-mc-grass-dark' : 'border-mc-card-border bg-mc-dark-bg'
                }`}
              >
              ...
              <span className="text-gray-400 text-xs font-body leading-relaxed">
                I agree to the{' '}
                <Link href="/terms" className="text-mc-diamond hover:underline">Terms of Service</Link>
                {' '}and{' '}
        ...
        <p className="text-center text-xs text-gray-600 font-mono mt-6">
          7-day money-back guarantee · No credit card for signup
        </p>
      </div>
    </div>
  )
